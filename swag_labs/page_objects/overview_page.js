class Overview {
    constructor() {
        ...
        this.$overviewProductPrice = () => $('//div[text()="Sauce Labs Fleece Jacket"]//..//following-sibling::div[@class="item_pricebar"]/div');
        ...
        this.$finish = () => $('//div[@class="cart_footer"]//button[text()="Finish"]');

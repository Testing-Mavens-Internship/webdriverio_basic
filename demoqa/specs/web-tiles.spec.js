...
xdescribe("Demo QA Application Text Box automation", () => {
  ...
  it("click the submit button and Viewing the input field", async () => {
    ...
    expect(await webTablesPage.$output("tester@gmail.com").isDisplayed()).toBe(
      true
    );
  ...
  it("Click on the edit icon and entering the values", async () => {
    ...
    expect(await webTablesPage.$output("sreerag@gmail.com").isDisplayed()).toBe(
      true
    );

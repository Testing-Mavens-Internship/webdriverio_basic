...
xdescribe("Demo QA Application checkbox automation", () => {
  ...
  it("click on the buttons and validating", async () => {
    ...
    expect(await buttonPage.$text("double").isDisplayed())
      .withContext("Expect double click message to be displayed")
      .toBe(true);
    expect(await buttonPage.$text("dynamic").isDisplayed())
      .withContext("Expect click message to be displayed")
      .toBe(true);
    expect(await buttonPage.$text("right").isDisplayed())
      .withContext("Expect right click message to be displayed")
      .toBe(true);

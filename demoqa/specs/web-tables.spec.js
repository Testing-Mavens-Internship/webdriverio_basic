...
const {webTablesPage} = require('../page-objects/web-tables.js');
...
xdescribe("Demo QA Application Text Box automation", () => {
  ...
  it("Click on the edit icon and entering the values" ,async() =>{
    ...
    expect(await webTablesPage.$output("athira@gmail.com").isDisplayed()).toBe(true);
  ...
  it("Click on the delete icon and verifying the values" , async() =>{
    ...
    expect(await webTablesPage.$output("athira@gmail.com").isDisplayed()).toBe(false);

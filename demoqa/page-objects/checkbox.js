...
class CheckBox{
    ...
    constructor() {
        ...
        this.$box = ()=> $('//span[text()="Home"]/..//span[@class="rct-checkbox"]');
        this.$description = (notes) => $(`//span[text()="${notes}"]`)
        this.$toggle = (options)=> $(`//span[text()="${options}"]/../preceding-sibling::button`);
    ...
    async boxCheck(){
     ...
     async togglebutton(){
    let b  = ["Home","Desktop", "Documents", "Downloads", "WorkSpace", "Office"]

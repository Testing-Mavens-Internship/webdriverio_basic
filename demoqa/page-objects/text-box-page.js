 ...
 */
    async clickOnFullName(fullName){
        ...
        await this.$input(fullName).setValue("Aparna Udayan")
 ...
 */
    async clickOnEmail(email){
        ...
        await this.$input(email).setValue("aparnaudayan@gmail.com")
    ...
    async clickOnCurrentAdd(caddress){
        ...
        await this.$address(caddress).setValue("Kunnuvilayil, vayala Pathanmthitta");
 ...
 */
    async clickOnPermanentAdd(paddress){
        ...
        await this.$address(paddress).setValue("Kunnuvilayil, Vayala Pathanmthitta");
    ...
    async clickOnSubmit(){
        ...
        await this.$details("Aparna Udayan").waitForDisplayed({timeout:10000});
    }
    /**

...
class SelectedProduct extends Common{
    constructor(){
        super();
        this.$selectedProductHeader=()=>$(`//h1[text()="Gojo Co-Ords Set for Men"]`) //selected product name as heading in selected product page
        ...
        this.$productAddConformation=()=>$(`//div[contains(text(),' “Gojo Co-Ords Set for Men” has been added to your cart.')]`) // product add conformation title
      }
      /**
       * 

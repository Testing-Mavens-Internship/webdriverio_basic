...
class TravelPage extends Common{
    constructor(){
        ...
        this.$departdate=(date)=>$(`//div[text()="October 2023"]/../../../.././/button[text()="${date}"]`) //selecting the date
        ...
        this.$flightRouteValidation=()=>$(`//span[@class="_3b3BQ2" or contains(text(),"COK")]/../..//div[@class="_3q4yZe" or contains(text(),"LAX")]`) //validating To/From of listed flights
    }
    /**

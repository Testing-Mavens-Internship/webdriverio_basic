...
import { contactPage } from "../page-object/contactUs-page.js";
import { cartPage } from "../page-object/cart-page.js";

let firstName = "Batman";
let eMail = "Bat@mail.com";
let phoneNumber = "2255390";
let message = "Dark night is coming";
let fullName = "Patrick batman";
let address = "BatHouse";
let city = "gotham";
let state = "Nj";
let zipCode = "680500";
let nameOnCard = "Patrick";

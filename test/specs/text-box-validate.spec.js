...
xdescribe('demoqa website text box validation', () => {
    ...
    it("Details of the entered input", async() => {
        expect(await textBox.$details("Alen Salu").isDisplayed()).withContext("Expect name field to be displayed").toBe(true);
        expect(await textBox.$details("a@gmail.com").isDisplayed()).withContext("Expect email field to be displayed").toBe(true);
        expect(await textBox.$details("Kunnuvilayil, vayala P").isDisplayed()).withContext("Expect current address field to be displayed").toBe(true);
        expect(await textBox.$details("Kunnuvilayil, Vayala P").isDisplayed()).withContext("Expect permanenet address field to be displayed").toBe(true);

class ProductPage{
    constructor(){
         ...
         * elements
         */
        this.$tsize= (size) => $(`//label[text()="T-shirt Size"]/../..//span[text()="${size}"]//..`);
        this.$ssize= (size) => $(`//label[text()="Shorts Size"]/../..//span[text()="${size}"]//..`);
        ...
        this.$itemAddedMessage = () => $ ('//div[@class="box-content" and contains(text(),"Gojo")]')
    }
/**
 * 
 * @param {string} tsize 
